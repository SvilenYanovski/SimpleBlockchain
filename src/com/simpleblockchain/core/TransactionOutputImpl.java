...
public class TransactionOutputImpl implements TransactionOutput{
	...
	//Constructor
	public TransactionOutputImpl(PublicKey reciepient, float value, String parentTransactionId) {
		this.reciepient = reciepient;
		this.value = value;
		this.parentTransactionId = parentTransactionId;
		this.id = StringUtil.digestSha256(StringUtil.getStringFromKey(reciepient)+Float.toString(value)+parentTransactionId);
	}
